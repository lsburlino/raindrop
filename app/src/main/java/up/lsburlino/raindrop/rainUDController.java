...
/**
 ...
 CS 301
 Up/Down controller class. Controls up down movement and combining drops
 */
public class rainUDController implements SeekBar.OnSeekBarChangeListener{
    ...
    public rainUDController (rainView rainview){
        this.rainview = rainview;
    }
    @Override
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        this.rainview.theDrop.changeY(progress);
        ...
        while(i < this.rainview.drops.size()) {
            ...
            if (dist<60){
                ...
                //increment array loop if not removed
            }
            else{
                i++;
            }
